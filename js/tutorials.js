...
//Cross platform ( farklı işletim sistemlerinde de çalışıyor.)
// OOP uygun.
...
// console.log(typeof result+ " => "+result);  //output= string => Js öğreniyorum

// var result="4423";
// console.log(typeof result+ " => "+result);  // output= number => 4423

// var result="44.23";
// console.log(typeof result+ " => "+result); // output= number => 44.23

// var result="true";
// console.log(typeof result+ " => "+result);  // output= boolean => true

// var result="JavaScript";   //output= JavaScript
// console.log(result);
...
//var ~44deneme="JS Data";    => sayı ile, ~ sembolü ile başlayamaz.
//console.log(~44deneme);
...
// var userData=prompt("Lütfen sayı giriniz:");    //sayı olarak 55 girersek output:
// console.log(userData+45);                      //5545 çıkar. Çünkü string bir ifade

// var userData=Number(prompt("Lütfen sayı giriniz:"));   //burada output;
// console.log(userData+45);                             // 100 olur.

// //undefined
// var result4;              //outout:
// console.log(result4);    //undefined

// var result5="asd"/4;     //output:
// console.log(result5);    //NaN

// var result6=4;                //output:
...
// console.log(Math.floor(3.9));   //hep bir küçük tam sayıya yuvarlar
// console.log(Math.ceil(3.1));   //hep bir büyük tam sayıya yuvarlar
// console.log(Math.round(6.4)); 
// console.log(Math.round(6.5));

// console.log(Math.sin(45));
// console.log(Math.random()*9+1); //random ondalık sayı verir. 
// console.log(Math.round(Math.random()*9+1)); //random tam sayı verir.
...
// console.log(Number("10")+10);     //output=20
// console.log(parseInt("10")+10);  //output=20

// console.log(String(30)+10);     //output=3010
// var number=30;
// console.log(number.toString()+10);  //output=3010
...
// //let data2=44;         // Bu ifade hata verir.
// //console.log(data2)
...
// const data4=55;         //hata verir. Çünkü "const"ta ifadeyi bir kere tanımyalınca daha değiştiremezsin.
// data5=66;
// console.log(data4);
...
// console.log(str.length);  //length=kaç harf olduğunu söyler
// console.log(str.trim().length);  // trim baştaki ve sondaki boşlukları alır ve length ile kaç harf olduğu o şekilde söylenir.

// console.log(str.toLowerCase());  //cümledeki her şeyi küçük karakterli yapar.
// console.log(str.toUpperCase());  //cümledeki her şeyi büyük karakterli yapar

// console.log(str.charAt(0));  //0. kelimeyi verir.

// console.log(str.indexOf("js")); //cümlede js i soldan arar ve nerede başlıyorsa onu verir. Örneğin burada output 0 dır.
// console.log(str.lastIndexOf("js")); //cümlede js i sondan arar. output=15 olur.

// console.log(str.concant("sona"));  //"concant" cümlenin sonuna eklenecek keliemeyi ekler. output=js ÖĞreniyorum js sona
// console.log(str.replace(str,"değiştir"));  //"replace" cümleyi yazılan cümle ya da kelime ile değiştirir. output=değiştir

// console.log(str.substring(1));       //output=s ÖĞreniyorum js
// console.log(str.substring(0,4));    //output=js Ö
...
// function retursuzParametresiz(){    //output:deneme
//     console.log("deneme");
// }
...
//     console.log("deneme"+adi);           //output:deneme CerenP
// }
// retursuzParametreli("CerenP")     //argüman: "CerenP"

        //3 returnlu Parametresiz
// function returnluParametresiz(){
//     return "deneme55";                  //output:deneme55
// }
...
//     return "deneme66"+soyadi;           //output:deneme66 Pazarözyurt
// }
// let result4= returnluParametreli("Pazarözyurt");
// console.log(result4);
...
// deneme3();
        ...
        // Inmedia Function ()();       //amaç fonsiyon biz çağırmadan gelsin
// (function(){                           //çok kullanılmaz ama genellikle main yapılarında kullanılır.
//     console.log("deneme4");
// })();

///////////////////////////////////////////////////
//let veya const
//arrow function  bu derste bunları sık kullanılacağız.
...
const condi5 = () => {
    let number = 4;
    if (number == "1") {      // === (3) tane eşittir olursa bu sefer türüne de bakar. number ve string ifadeleri birbirine denk görmez.
        console.log("1");
    } else if (number == 2) {
        console.log("2");
    } else if (number == 3) {
...
////////////////////////////////////////////////////////
// try catch (Error Handling) (hatayı yakalamak için yapılan bir yapı)
let tryCatchTuto = () => {
    try {
        alertx("pop-pup");
    } catch (error) {
        ...
        console.log("db.close");              //kapatılması zorunlu olan yapıları finally içine yazıp kapatılmasını sağlıyoruz.
